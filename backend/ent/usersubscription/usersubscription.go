...
var (
	...
	// DefaultCacheRevision holds the default value on creation for the "cache_revision" field.
	DefaultCacheRevision int64
...
func ByCacheRevision(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldCacheRevision, opts...).ToFunc()
}
